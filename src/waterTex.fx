...
PixelShader PS_WaterTex
<
    string NoiseTextureSampler  = "parameter register(1)";
    string NormalTextureSampler = "parameter register(0)";
    string waterSimParam        = "parameter register(72)";
    string waterTexResValue     = "parameter register(66)";
> =
asm
{
    //
