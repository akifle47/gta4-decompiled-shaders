...
struct VS_TransformPtfxColInput
{
    float3 Position : POSITION;
    float3 Normal : NORMAL;
};
struct VS_TransformPtfxColOutput
{
...
VS_TransformPtfxColOutput VS_TransformPtfxCol(VS_TransformPtfxColInput IN)
{
    VS_TransformPtfxColOutput OUT;
    
    OUT.Normal.xyz = mul(IN.Normal, (float3x3)gWorldViewProj);
...
VertexShader VS_TransformSkinPtfxCol
<
...
technique draw
{
    pass p0
    {
        ...
        VertexShader = compile vs_3_0 VS_TransformPtfxCol();
        PixelShader = PS_Draw;
    }
}
