...
<
    string gWorldInstanceInverseTranspose = "parameter register(212)";
    string gWorldInstanceMatrix           = "parameter register(208)";
...
PixelShader PS_TexturedUnlitInst
<
    string TextureSampler = "parameter register(0)";
> =
asm
...
PixelShader PS_TexturedZeroInst
<
    string StippleTexture       = "parameter register(10)";
    string TextureSampler       = "parameter register(0)";
    string gDepthFxParams       = "parameter register(16)";
...
PixelShader PS_TexturedFourInst
<
    string StippleTexture       = "parameter register(10)";
    string TextureSampler       = "parameter register(0)";
    string gDepthFxParams       = "parameter register(16)";
